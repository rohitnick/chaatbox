class HomeController < ApplicationController
  ...
  private
  def chaat_params
    params.require(:details).permit(:customers_name,:customers_street_address,:customers_telephone,:customers_email_address,:order_total,:deliveryarea,:time,:payableamount,:product => [],:quantity => [])
  end
end
